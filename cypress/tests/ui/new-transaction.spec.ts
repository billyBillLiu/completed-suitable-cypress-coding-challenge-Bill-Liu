...
describe("New Transaction", function () {
  ...
  const testTransaction = (transaction: {amount: string, description: string}, submitType: string) => {
    ...
    cy.getBySelLike("amount-input").type(transaction.amount);
    cy.getBySelLike("description-input").type(transaction.description);
    cy.visualSnapshot("Amount and Description Input");
    cy.getBySelLike(submitType).click();
    ...
    cy.getBySelLike("transaction-item").should("contain", transaction.description);
  ...
  it("navigates to the new transaction form, selects a user and submits a transaction request", function () {
    ...
    testTransaction(request, "submit-request");
  });
  ...
  it("navigates to the new transaction form, selects a user and submits a transaction payment", function () {
    ...
    // Call refactored function with payment and submitType
    testTransaction(payment, "submit-payment");
  });
});
